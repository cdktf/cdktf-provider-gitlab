// https://registry.terraform.io/providers/gitlabhq/gitlab/18.0.0/docs/resources/compliance_framework
...
export class ComplianceFramework extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComplianceFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.0.0/docs/resources/compliance_framework#import import section} in the documentation of this resource for the id to use
