// https://registry.terraform.io/providers/gitlabhq/gitlab/17.7.1/docs/resources/repository_file
...
export class RepositoryFile extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RepositoryFile that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.7.1/docs/resources/repository_file#import import section} in the documentation of this resource for the id to use
