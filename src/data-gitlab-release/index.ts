...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.1/docs/data-sources/release
...
export class DataGitlabRelease extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabRelease that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.1/docs/data-sources/release#import import section} in the documentation of this resource for the id to use
