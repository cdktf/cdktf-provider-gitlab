...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.1/docs/resources/label
...
export class Label extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Label that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.1/docs/resources/label#import import section} in the documentation of this resource for the id to use
