// https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/data-sources/project_issues
...
export class DataGitlabProjectIssues extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProjectIssues that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/data-sources/project_issues#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      not_assignee_id: {
        value: cdktf.listMapperHcl(cdktf.numberToHclTerraform, false)(this._notAssigneeId),
        isBlock: false,
        type: "list",
        storageClassType: "numberList",
      },
      not_author_id: {
        value: cdktf.listMapperHcl(cdktf.numberToHclTerraform, false)(this._notAuthorId),
        isBlock: false,
        type: "list",
        storageClassType: "numberList",
      },
      ...
      not_my_reaction_emoji: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._notMyReactionEmoji),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
