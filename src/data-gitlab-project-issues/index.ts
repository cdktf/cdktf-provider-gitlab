...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.0/docs/data-sources/project_issues
...
export function dataGitlabProjectIssuesIssuesTaskCompletionStatusToHclTerraform(struct?: DataGitlabProjectIssuesIssuesTaskCompletionStatus): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataGitlabProjectIssuesIssuesToHclTerraform(struct?: DataGitlabProjectIssuesIssues): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataGitlabProjectIssues extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabProjectIssues that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.0/docs/data-sources/project_issues#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  public get notAssigneeId() {
    return this.getNumberAttribute('not_assignee_id');
  }
  ...
  public get notAuthorId() {
    return this.getNumberAttribute('not_author_id');
  }
  ...
  public get notMyReactionEmoji() {
    return this.getStringAttribute('not_my_reaction_emoji');
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      not_assignee_id: cdktf.numberToTerraform(this._notAssigneeId),
      not_author_id: cdktf.numberToTerraform(this._notAuthorId),
      ...
      not_my_reaction_emoji: cdktf.stringToTerraform(this._notMyReactionEmoji),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      assignee_username: {
        value: cdktf.stringToHclTerraform(this._assigneeUsername),
        isBlock: false,
        type: "simple",
      ...
      not_assignee_id: {
        value: cdktf.numberToHclTerraform(this._notAssigneeId),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      not_author_id: {
        value: cdktf.numberToHclTerraform(this._notAuthorId),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      not_labels: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._notLabels),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      not_milestone: {
        value: cdktf.stringToHclTerraform(this._notMilestone),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      not_my_reaction_emoji: {
        value: cdktf.stringToHclTerraform(this._notMyReactionEmoji),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      with_labels_details: {
        value: cdktf.booleanToHclTerraform(this._withLabelsDetails),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
