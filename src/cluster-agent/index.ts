// https://registry.terraform.io/providers/gitlabhq/gitlab/17.5.0/docs/resources/cluster_agent
...
export class ClusterAgent extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.5.0/docs/resources/cluster_agent#import import section} in the documentation of this resource for the id to use
