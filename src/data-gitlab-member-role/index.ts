...
export class DataGitlabMemberRole extends cdktf.TerraformDataSource {
  ...
  */
  public constructor(scope: Construct, id: string, config: DataGitlabMemberRoleConfig) {
    super(scope, id, {
  ...
  // base_access_level - computed: true, optional: false, required: false
  ...
  // enabled_permissions - computed: true, optional: false, required: false
