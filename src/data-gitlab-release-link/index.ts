// https://registry.terraform.io/providers/gitlabhq/gitlab/16.5.0/docs/data-sources/release_link
...
export class DataGitlabReleaseLink extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabReleaseLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.5.0/docs/data-sources/release_link#import import section} in the documentation of this resource for the id to use
