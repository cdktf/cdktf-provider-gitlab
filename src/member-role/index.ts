...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.1/docs/resources/member_role
...
export class MemberRole extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MemberRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.1/docs/resources/member_role#import import section} in the documentation of this resource for the id to use
