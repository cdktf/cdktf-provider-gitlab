// https://registry.terraform.io/providers/gitlabhq/gitlab/16.6.0/docs/data-sources/application
...
export class DataGitlabApplication extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.6.0/docs/data-sources/application#import import section} in the documentation of this resource for the id to use
