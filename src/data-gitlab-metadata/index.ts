...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.0.1/docs/data-sources/metadata
...
export class DataGitlabMetadata extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.0.1/docs/data-sources/metadata#import import section} in the documentation of this resource for the id to use
