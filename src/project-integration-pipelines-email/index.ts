...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.2.0/docs/resources/project_integration_pipelines_email
...
export class ProjectIntegrationPipelinesEmail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIntegrationPipelinesEmail that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.2.0/docs/resources/project_integration_pipelines_email#import import section} in the documentation of this resource for the id to use
