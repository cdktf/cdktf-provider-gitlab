...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/integration_pipelines_email
...
export interface IntegrationPipelinesEmailConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class IntegrationPipelinesEmail extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "gitlab_integration_pipelines_email";
  ...
  * @param importFromId The id of the existing IntegrationPipelinesEmail that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/integration_pipelines_email#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "gitlab_integration_pipelines_email", importId: importFromId, provider });
      }
  ...
  * @param options IntegrationPipelinesEmailConfig
  */
  public constructor(scope: Construct, id: string, config: IntegrationPipelinesEmailConfig) {
    super(scope, id, {
