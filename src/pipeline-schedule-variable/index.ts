// https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/pipeline_schedule_variable
...
export class PipelineScheduleVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PipelineScheduleVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/pipeline_schedule_variable#import import section} in the documentation of this resource for the id to use
