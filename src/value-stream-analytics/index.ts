...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.9.0/docs/resources/value_stream_analytics
...
export class ValueStreamAnalytics extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ValueStreamAnalytics that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.9.0/docs/resources/value_stream_analytics#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _stages = new ValueStreamAnalyticsStagesList(this, "stages", true);
  public get stages() {
    return this._stages;
  }
