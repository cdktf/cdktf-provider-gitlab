// https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/application_settings
...
export interface ApplicationSettingsConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Enable delayed project deletion by default in new groups. From GitLab 15.1, can only be enabled when delayed_group_deletion is true.
  *
...
export class ApplicationSettings extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/application_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  // delayed_group_deletion - computed: true, optional: true, required: false
  private _delayedGroupDeletion?: boolean | cdktf.IResolvable; 
  public get delayedGroupDeletion() {
    return this.getBooleanAttribute('delayed_group_deletion');
  }
  public set delayedGroupDeletion(value: boolean | cdktf.IResolvable) {
    this._delayedGroupDeletion = value;
  }
  public resetDelayedGroupDeletion() {
    this._delayedGroupDeletion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get delayedGroupDeletionInput() {
    return this._delayedGroupDeletion;
  }

  // delayed_project_deletion - computed: true, optional: true, required: false
  private _delayedProjectDeletion?: boolean | cdktf.IResolvable; 
  public get delayedProjectDeletion() {
    return this.getBooleanAttribute('delayed_project_deletion');
  }
  public set delayedProjectDeletion(value: boolean | cdktf.IResolvable) {
    this._delayedProjectDeletion = value;
  }
  public resetDelayedProjectDeletion() {
    this._delayedProjectDeletion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get delayedProjectDeletionInput() {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      delayed_group_deletion: {
        value: cdktf.booleanToHclTerraform(this._delayedGroupDeletion),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      delayed_project_deletion: {
        value: cdktf.booleanToHclTerraform(this._delayedProjectDeletion),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      elasticsearch_namespace_ids: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._elasticsearchNamespaceIds),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      ...
      elasticsearch_project_ids: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._elasticsearchProjectIds),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
