...
// https://registry.terraform.io/providers/gitlabhq/gitlab/16.6.0/docs/resources/instance_variable
...
export class InstanceVariable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstanceVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.6.0/docs/resources/instance_variable#import import section} in the documentation of this resource for the id to use
