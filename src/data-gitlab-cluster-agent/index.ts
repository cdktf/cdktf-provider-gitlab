...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/data-sources/cluster_agent
...
export class DataGitlabClusterAgent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabClusterAgent that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/data-sources/cluster_agent#import import section} in the documentation of this resource for the id to use
