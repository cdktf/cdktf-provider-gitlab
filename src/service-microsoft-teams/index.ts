...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.0.1/docs/resources/service_microsoft_teams
...
export class ServiceMicrosoftTeams extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceMicrosoftTeams that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.0.1/docs/resources/service_microsoft_teams#import import section} in the documentation of this resource for the id to use
