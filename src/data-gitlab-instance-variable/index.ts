// https://registry.terraform.io/providers/gitlabhq/gitlab/16.8.0/docs/data-sources/instance_variable
...
export class DataGitlabInstanceVariable extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabInstanceVariable that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.8.0/docs/data-sources/instance_variable#import import section} in the documentation of this resource for the id to use
