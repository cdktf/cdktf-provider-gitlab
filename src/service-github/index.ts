// https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/service_github
...
export class ServiceGithub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceGithub that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/service_github#import import section} in the documentation of this resource for the id to use
