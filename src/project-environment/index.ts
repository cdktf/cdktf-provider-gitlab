...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/project_environment
...
export class ProjectEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/project_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ProjectEnvironmentConfig) {
    ...
    this._autoStopSetting = config.autoStopSetting;
  ...
  // auto_stop_setting - computed: true, optional: true, required: false
  private _autoStopSetting?: string; 
  public get autoStopSetting() {
    return this.getStringAttribute('auto_stop_setting');
  }
  public set autoStopSetting(value: string) {
    this._autoStopSetting = value;
  }
  public resetAutoStopSetting() {
    this._autoStopSetting = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get autoStopSettingInput() {
    return this._autoStopSetting;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      auto_stop_setting: cdktf.stringToTerraform(this._autoStopSetting),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      auto_stop_setting: {
        value: cdktf.stringToHclTerraform(this._autoStopSetting),
        isBlock: false,
        type: "simple",
