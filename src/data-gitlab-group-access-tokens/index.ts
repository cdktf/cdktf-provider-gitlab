...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/data-sources/group_access_tokens
...
export class DataGitlabGroupAccessTokens extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGitlabGroupAccessTokens that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.1.0/docs/data-sources/group_access_tokens#import import section} in the documentation of this resource for the id to use
