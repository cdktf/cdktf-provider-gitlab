// https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/resources/group_membership
...
export class GroupMembership extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/resources/group_membership#import import section} in the documentation of this resource for the id to use
