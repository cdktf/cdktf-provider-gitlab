// https://registry.terraform.io/providers/gitlabhq/gitlab/17.0.1/docs/resources/topic
...
export class Topic extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Topic that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.0.1/docs/resources/topic#import import section} in the documentation of this resource for the id to use
