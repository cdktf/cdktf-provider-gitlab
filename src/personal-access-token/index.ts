// https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/resources/personal_access_token
...
export class PersonalAccessToken extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PersonalAccessToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/resources/personal_access_token#import import section} in the documentation of this resource for the id to use
