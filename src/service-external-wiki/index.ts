...
// https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/service_external_wiki
...
export class ServiceExternalWiki extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceExternalWiki that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.4.0/docs/resources/service_external_wiki#import import section} in the documentation of this resource for the id to use
