// https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/deploy_key
...
export class DeployKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeployKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/deploy_key#import import section} in the documentation of this resource for the id to use
