...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.0/docs/resources/integration_custom_issue_tracker
...
export class IntegrationCustomIssueTracker extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationCustomIssueTracker that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.0/docs/resources/integration_custom_issue_tracker#import import section} in the documentation of this resource for the id to use
