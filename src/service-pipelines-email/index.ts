// https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/resources/service_pipelines_email
...
export class ServicePipelinesEmail extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePipelinesEmail that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.3.1/docs/resources/service_pipelines_email#import import section} in the documentation of this resource for the id to use
