...
// https://registry.terraform.io/providers/gitlabhq/gitlab/18.2.0/docs/resources/project_integration_jira
...
export interface ProjectIntegrationJiraConfig extends cdktf.TerraformMetaArguments {
  /**
...
*/
export class ProjectIntegrationJira extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "gitlab_project_integration_jira";
  ...
  * @param importToId The construct id used in the generated config for the ProjectIntegrationJira to import
  * @param importFromId The id of the existing ProjectIntegrationJira that should be imported. Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.2.0/docs/resources/project_integration_jira#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "gitlab_project_integration_jira", importId: importFromId, provider });
      }
  ...
  * @param options ProjectIntegrationJiraConfig
  */
  public constructor(scope: Construct, id: string, config: ProjectIntegrationJiraConfig) {
    super(scope, id, {
      terraformResourceType: 'gitlab_project_integration_jira',
