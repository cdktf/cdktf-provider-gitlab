...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/projectcomplianceframework"
...
Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/project_compliance_framework#import import section} in the documentation of this resource for the id to use
