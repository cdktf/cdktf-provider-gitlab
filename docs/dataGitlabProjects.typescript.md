...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabProjects.DataGitlabProjects.property.count">count</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabProjects.DataGitlabProjectsConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly operationsAccessLevel: string;
```
