...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/servicepipelinesemail"
...
| <code><a href="#@cdktf/provider-gitlab.servicePipelinesEmail.ServicePipelinesEmailConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/service_pipelines_email#id ServicePipelinesEmail#id}. |
