...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v15/application"
...
Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/application#import import section} in the documentation of this resource for the id to use
