...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/application"
...
Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/application#import import section} in the documentation of this resource for the id to use
