...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/datagitlabgroups"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabGroups.DataGitlabGroupsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.9.1/docs/data-sources/groups#id DataGitlabGroups#id}. |
