...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v10/integrationslack"
...
| <code><a href="#@cdktf/provider-gitlab.integrationSlack.IntegrationSlackConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.0/docs/resources/integration_slack#id IntegrationSlack#id}. |
