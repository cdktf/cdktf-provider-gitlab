...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v10/instancecluster"
...
| <code><a href="#@cdktf/provider-gitlab.instanceCluster.InstanceClusterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.1/docs/resources/instance_cluster#id InstanceCluster#id}. |
