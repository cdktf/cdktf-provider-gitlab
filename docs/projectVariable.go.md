...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/projectvariable"
...
| <code><a href="#@cdktf/provider-gitlab.projectVariable.ProjectVariableConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.10.0/docs/resources/project_variable#id ProjectVariable#id}. |
