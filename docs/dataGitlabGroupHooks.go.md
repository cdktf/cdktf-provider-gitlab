...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/datagitlabgrouphooks"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabGroupHooks.DataGitlabGroupHooksConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/group_hooks#id DataGitlabGroupHooks#id}. |
