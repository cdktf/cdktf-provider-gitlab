...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/servicegithub"
...
| <code><a href="#@cdktf/provider-gitlab.serviceGithub.ServiceGithubConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/service_github#id ServiceGithub#id}. |
