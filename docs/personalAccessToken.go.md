...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/personalaccesstoken"
...
| <code><a href="#@cdktf/provider-gitlab.personalAccessToken.PersonalAccessTokenConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.11.0/docs/resources/personal_access_token#id PersonalAccessToken#id}. |
