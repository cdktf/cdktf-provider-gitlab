...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v11/personalaccesstoken"
...
| <code><a href="#@cdktf/provider-gitlab.personalAccessToken.PersonalAccessTokenConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.1/docs/resources/personal_access_token#id PersonalAccessToken#id}. |
