...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12/datagitlabrelease"
...
&datagitlabrelease.DataGitlabReleaseConfig {
	...
	ProjectId: *string,
	TagName: *string,
	Assets: github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v12.dataGitlabRelease.DataGitlabReleaseAssets,
}
```
