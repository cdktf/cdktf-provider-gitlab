...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v10/systemhook"
...
| <code><a href="#@cdktf/provider-gitlab.systemHook.SystemHookConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.3.0/docs/resources/system_hook#id SystemHook#id}. |
