...
```typescript
public resetOperationsAccessLevel(): void
```
...
| <code><a href="#@cdktf/provider-gitlab.project.Project.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly operationsAccessLevelInput: string;
```
...
| <code><a href="#@cdktf/provider-gitlab.project.ProjectConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
