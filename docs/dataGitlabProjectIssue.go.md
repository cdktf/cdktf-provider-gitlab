...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/datagitlabprojectissue"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabProjectIssue.DataGitlabProjectIssueConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/data-sources/project_issue#id DataGitlabProjectIssue#id}. |
