...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v15/topic"
...
| <code><a href="#@cdktf/provider-gitlab.topic.TopicConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.0/docs/resources/topic#id Topic#id}. |
