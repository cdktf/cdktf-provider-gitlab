...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v10/serviceslack"
...
| <code><a href="#@cdktf/provider-gitlab.serviceSlack.ServiceSlackConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.0/docs/resources/service_slack#id ServiceSlack#id}. |
