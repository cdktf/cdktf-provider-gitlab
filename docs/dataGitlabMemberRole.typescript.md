...
```typescript
import { dataGitlabMemberRole } from '@cdktf/provider-gitlab'

new dataGitlabMemberRole.DataGitlabMemberRole(scope: Construct, id: string, config: DataGitlabMemberRoleConfig)
```
...
dataGitlabMemberRole.DataGitlabMemberRole.isConstruct(x: any)
```
...
dataGitlabMemberRole.DataGitlabMemberRole.isTerraformElement(x: any)
```
...
dataGitlabMemberRole.DataGitlabMemberRole.isTerraformDataSource(x: any)
```
...
dataGitlabMemberRole.DataGitlabMemberRole.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRole.property.cdktfStack">cdktfStack</a></code> | <code>cdktf.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRole.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRole.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktf.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRole.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRole.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRole.property.iid">iid</a></code> | <code>number</code> | *No description.* |
...
const dataGitlabMemberRoleConfig: dataGitlabMemberRole.DataGitlabMemberRoleConfig = { ... }
```
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRoleConfig.property.count">count</a></code> | <code>number \| cdktf.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRoleConfig.property.dependsOn">dependsOn</a></code> | <code>cdktf.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRoleConfig.property.forEach">forEach</a></code> | <code>cdktf.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabMemberRole.DataGitlabMemberRoleConfig.property.provisioners">provisioners</a></code> | <code>cdktf.FileProvisioner \| cdktf.LocalExecProvisioner \| cdktf.RemoteExecProvisioner[]</code> | *No description.* |
