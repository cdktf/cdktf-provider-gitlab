...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v7/datagitlabproject"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabProject.DataGitlabProject.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
##### `OperationsAccessLevel`<sup>Required</sup> <a name="OperationsAccessLevel" id="@cdktf/provider-gitlab.dataGitlabProject.DataGitlabProject.property.operationsAccessLevel"></a>
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabProject.DataGitlabProjectConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
