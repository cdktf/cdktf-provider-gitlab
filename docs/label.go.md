...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v7/label"
...
| <code><a href="#@cdktf/provider-gitlab.label.Label.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.label.LabelConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
