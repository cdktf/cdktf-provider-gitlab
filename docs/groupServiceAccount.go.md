...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/groupserviceaccount"
...
Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/group_service_account#import import section} in the documentation of this resource for the id to use
