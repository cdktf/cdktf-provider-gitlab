...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v11/datagitlabgroupvariables"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabGroupVariables.DataGitlabGroupVariablesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.6.0/docs/data-sources/group_variables#id DataGitlabGroupVariables#id}. |
