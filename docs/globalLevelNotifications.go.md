...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/globallevelnotifications"
...
Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/global_level_notifications#import import section} in the documentation of this resource for the id to use
