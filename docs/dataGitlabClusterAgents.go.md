...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v11/datagitlabclusteragents"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabClusterAgents.DataGitlabClusterAgentsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.1/docs/data-sources/cluster_agents#id DataGitlabClusterAgents#id}. |
