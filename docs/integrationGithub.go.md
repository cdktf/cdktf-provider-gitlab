...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v15/integrationgithub"
...
| <code><a href="#@cdktf/provider-gitlab.integrationGithub.IntegrationGithubConfig.property.staticContext">StaticContext</a></code> | <code>interface{}</code> | Append the instance name instead of the branch to the status. |
