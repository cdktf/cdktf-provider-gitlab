...
| <code><a href="#@cdktf/provider-gitlab.projectAccessToken.ProjectAccessToken.property.validatePastExpirationDateInput">ValidatePastExpirationDateInput</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-gitlab.projectAccessToken.ProjectAccessToken.property.validatePastExpirationDate">ValidatePastExpirationDate</a></code> | <code>interface{}</code> | *No description.* |
...
&projectaccesstoken.ProjectAccessTokenConfig {
	...
	Description: *string,
	ExpiresAt: *string,
	RotationConfiguration: github.com/cdktf/cdktf-provider-gitlab-go/gitlab.projectAccessToken.ProjectAccessTokenRotationConfiguration,
...
| <code><a href="#@cdktf/provider-gitlab.projectAccessToken.ProjectAccessTokenConfig.property.validatePastExpirationDate">ValidatePastExpirationDate</a></code> | <code>interface{}</code> | Wether to validate if the expiration date is in the future. |
