...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v10/groupaccesstoken"
...
| <code><a href="#@cdktf/provider-gitlab.groupAccessToken.GroupAccessTokenConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.0/docs/resources/group_access_token#id GroupAccessToken#id}. |
