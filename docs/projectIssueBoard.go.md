...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v11/projectissueboard"
...
| <code><a href="#@cdktf/provider-gitlab.projectIssueBoard.ProjectIssueBoardConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.7.0/docs/resources/project_issue_board#id ProjectIssueBoard#id}. |
