...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v14/groupcluster"
...
| <code><a href="#@cdktf/provider-gitlab.groupCluster.GroupClusterConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.11.0/docs/resources/group_cluster#id GroupCluster#id}. |
