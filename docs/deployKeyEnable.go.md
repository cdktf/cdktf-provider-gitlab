...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v13/deploykeyenable"
...
| <code><a href="#@cdktf/provider-gitlab.deployKeyEnable.DeployKeyEnableConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/17.10.0/docs/resources/deploy_key_enable#id DeployKeyEnable#id}. |
