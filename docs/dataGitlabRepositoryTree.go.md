...
Refer to the Terraform Registory for docs: [`data_gitlab_repository_tree`](https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.0/docs/data-sources/repository_tree).
...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v10/datagitlabrepositorytree"
...
| <code><a href="#@cdktf/provider-gitlab.dataGitlabRepositoryTree.DataGitlabRepositoryTreeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/gitlabhq/gitlab/16.4.0/docs/data-sources/repository_tree#id DataGitlabRepositoryTree#id}. |
