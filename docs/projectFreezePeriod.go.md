...
```go
import "github.com/cdktf/cdktf-provider-gitlab-go/gitlab/v15/projectfreezeperiod"
...
Refer to the {@link https://registry.terraform.io/providers/gitlabhq/gitlab/18.4.0/docs/resources/project_freeze_period#import import section} in the documentation of this resource for the id to use
